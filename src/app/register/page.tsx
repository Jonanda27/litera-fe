      ...
      <div className="pt-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-slate-800 font-medium">Daftar</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4 py-8">
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-blue-900">Daftar di LITERA</h1>
            <p className="text-slate-500 text-sm mt-1">Bergabunglah dengan kami!</p>
          </div>
          
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="block text-slate-700 font-medium ml-1">Nama Lengkap</label>
              <div className={`relative transition-all duration-300 transform ${isFocused === 'name' ? 'scale-[1.02]' : ''}`}>
                <div className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors ${isFocused === 'name' ? 'text-blue-500' : 'text-slate-400'}`}>
