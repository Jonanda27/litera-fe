      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-gradient-to-r from-indigo-600 to-blue-700 p-6 rounded-[2rem] shadow-lg text-white gap-4">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-6 py-3 rounded-xl font-black text-xs uppercase tracking-widest transition-all shadow-xl active:scale-95 ${
            saveSuccess ? "bg-emerald-500 text-white" : "bg-white text-indigo-700 hover:bg-indigo-50"
          } disabled:opacity-50`}
        >
            ...
            {isCompressing && !formData.coverFront ? (
              ...
              <>
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center gap-2 backdrop-blur-sm">
                  <button onClick={(e) => { e.stopPropagation(); frontInputRef.current?.click(); }} className="bg-white text-indigo-600 px-4 py-2 rounded-xl text-[10px] font-black uppercase">Ganti</button>
          ...
          >
            ...
            {isCompressing && !formData.coverBack ? (
              ...
              <>
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center gap-2 backdrop-blur-sm">
                  <button onClick={(e) => { e.stopPropagation(); backInputRef.current?.click(); }} className="bg-white text-indigo-600 px-4 py-2 rounded-xl text-[10px] font-black uppercase">Ganti</button>
