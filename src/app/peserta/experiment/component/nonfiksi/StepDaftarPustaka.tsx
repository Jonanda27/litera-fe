...
export default function StepSourceManagement({ formData, onDataChange }: StepSourceProps) {
  ...
  return (
    <div className="space-y-6 pb-10 text-slate-800 relative">
      ...
      {/* HEADER SECTION */}
      <div className="flex justify-between items-center bg-slate-900 p-5 rounded-[2rem] shadow-lg border-b-4 border-emerald-500/20">
        ...
        <button
          ...
          className={`px-5 py-2 rounded-xl text-[10px] font-black uppercase transition-all shadow-md active:scale-95 flex items-center gap-2 ${
            isAdding ? "bg-rose-500 text-white" : "bg-emerald-500 text-white hover:bg-emerald-600"
          }`}
        >
                ...
                <div className="flex flex-wrap gap-2">
                  {sourceTypes.map((t) => (
                    <button
                      ...
                      className={`py-2 px-4 rounded-full text-[10px] font-black uppercase transition-all border flex items-center gap-2 ${
                        newItem.type === t.label ? "bg-slate-900 border-slate-900 text-white shadow-lg" : "bg-slate-50 border-slate-100 text-slate-500 hover:border-emerald-200"
                      }`}
                    >
          ...
          >
            ...
            <div className="flex justify-between items-center border-t border-slate-50 pt-3">
              ...
              <span className={`text-[8px] font-black uppercase px-2 py-0.5 rounded ${
                item.credibility === 'Tinggi' ? 'bg-emerald-100 text-emerald-700' : 
