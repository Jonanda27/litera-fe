        ...
        <div className="mb-6 relative">
          ...
          <div className="relative group">
            <input
              ...
              className="w-full p-4 rounded-xl border-2 border-slate-100 bg-slate-50 focus:border-[#1E4E8C] outline-none font-bold text-slate-700 transition-all shadow-inner"
              autoFocus
            />
          </div>
        </div>
